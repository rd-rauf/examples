...
var bound = p.thisFunc.bind(p2, 10);       // Will point to p.thisFunc, passing 10 as argument
console.log("Change Object Fn", bound(100));       // 100 would be ignored !! It will only be used if argument value '10' is omitted above statement
